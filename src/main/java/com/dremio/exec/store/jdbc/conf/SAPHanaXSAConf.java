...
@SourceType(value = "SAPHanaXSAARP", label = "SAPHanaXSA",uiConfig = "saphanaxsa-layout.json")
public class SAPHanaXSAConf extends AbstractArpConf<SAPHanaXSAConf> {
  private static final String ARP_FILENAME = "arp/implementation/saphanaxsa-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.saphanaxsa.SAPHanaXSADriver";
